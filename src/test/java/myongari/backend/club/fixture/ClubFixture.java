...
public class ClubFixture {
    ...
    public static List<Club> 모든_동아리_정보_생성(Category category1, Category category2) {
        ...
        return List.of(new Club("동아리1", "학관1111", "https://sns.example.com/1", "https://image.example.com/1", "소개글 예시1", "활동 예시1",
                        동아리_1_지원_정보, 회장_1_정보, category1),
                new Club("동아리2", "학관2222", "https://sns.example.com/2", "https://image.example.com/2", "소개글 예시2", "활동 예시2",
                        동아리_2_지원_정보, 회장_2_정보, category2));
    }

    public static Category 카테고리_1_정보_생성() {
        return new Category("카테고리1");
    }

    public static Category 카테고리_2_정보_생성() {
        return new Category("카테고리2");
    }
}
